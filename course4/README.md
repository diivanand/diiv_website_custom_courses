...
C++20/CMake, Vulkan + Metal, one folder per lab. The build system is fully
...
`linux-release` / `linux-profile` (the Linux/4090 box).
...
Per-lab convention matches the Course 3 workspace: a lab is *done* when its
