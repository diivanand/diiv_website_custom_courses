# Course 3 — Embedded DSP: lab workspace

Bench workspace for [Course 3 on diiv.io](https://www.diiv.io/course3/) — 46 labs
...
cd course3/firmware/host                 # portable kernels — works right now
